/**********************************************************************
* Filename    : 034-01_camera_web_server
* Description : Building camera webserver
* Step 1: Connect the ESP32 Wrover board to the local network,
* and prints a url through a serial port.
* Step 2: Users visit the site to view the image data ESP32 camera.
...
void setup() {
  ...
  // 1. Initialize WiFi (Using your Dual Mode logic if you like)
  ...
  // 2. Start the Camera Server (This function is provided by the library)
  startCameraServer();
